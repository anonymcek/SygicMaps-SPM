...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.9.9/maps-ios-25.9.9.zip",
            checksum: "9847211adf3114bfc5fe5603b87982b3aa6050eab4b0b71e97b22e4a1336473f"
        )
    ]
)
