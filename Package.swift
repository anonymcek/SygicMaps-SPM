...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.8.2/maps-ios-25.8.2.zip",
            checksum: "ae847f4ab095f88f3ffad562398549ffa0bd81b2894a2a8f82836fae835882f8"
        )
    ]
)
