...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.9.4/maps-ios-25.9.4.zip",
            checksum: "a96bf65fb99aac30a37a78ec9378e85f26ac0310a00d0dc9f686f70470b5f7d3"
        )
    ]
)
