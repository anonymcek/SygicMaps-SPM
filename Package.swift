...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.9.3/maps-ios-25.9.3.zip",
            checksum: "1da8ead2c4655c2e4bec439df7c50f8165156b9b03af47e9ef1aad9e54e5e165"
        )
    ]
)
