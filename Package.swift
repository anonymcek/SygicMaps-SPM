...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.9.2/maps-ios-25.9.2.zip",
            checksum: "4b9be88374fa8beb771645cae619f047478f142bf1567259aca498a5f94d7972"
        )
    ]
)
