...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/27.1.2/maps-ios-27.1.2.zip",
            checksum: "7c7a556f5a120770f0cdba9215fe398c1aa8c3f550ea205c5ffa79527f80438e"
        )
    ]
)
