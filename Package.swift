...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.9.0/maps-ios-25.9.0.zip",
            checksum: "bddbdb6dcb21ad3e115716c16fa738f84e47a77f96abb8d498ecf1d2b424c6db"
        )
    ]
)
