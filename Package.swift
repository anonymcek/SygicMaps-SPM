...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.6.1/maps-ios-25.6.1.zip",
            checksum: "36a74866b3904a22ca2856ad4ff7b5db9f80cba7f8158c103d9f3aba81a43e78")
    ]
)
