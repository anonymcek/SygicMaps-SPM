...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/30.0.0/maps-ios-30.0.0.zip",
            checksum: "b35768d4690534b7936537238c0e7ed012c63a65da2fe1bd293dc0ed431b26e3"
        )
    ]
)
