...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.9.11/maps-ios-25.9.11.zip",
            checksum: "ef446b55fc4668eda1178f4522a0139b9a189ffdb86cd773c3f3fa202bcfe2f2"
        )
    ]
)
