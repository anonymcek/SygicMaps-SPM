...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.1.8/maps-ios-28.1.8.zip",
            checksum: "55e65fe0cd56042d451eed0bd6e26976e447a8dffe5c199078692635a1ac0852"
        )
    ]
)
