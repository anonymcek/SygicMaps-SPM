...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.3.1/maps-ios-28.3.1.zip",
            checksum: "f639b9c405417947b598c3e0cd8939e750893a8472595b34d9eb5fa43d111b71"
        )
    ]
)
