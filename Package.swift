...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/27.0.1/maps-ios-27.0.1.zip",
            checksum: "7c39cdf1fd3107edf091dd72d13287bfdfe8efbbb786d85cf332be6eadefd08b"
        )
    ]
)
