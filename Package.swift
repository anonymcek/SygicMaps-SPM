...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.1.11/maps-ios-28.1.11.zip",
            checksum: "065ed770c688275611fa609fd517e76f796df906afbb7e0eba8df91c5d410cd1"
        )
    ]
)
