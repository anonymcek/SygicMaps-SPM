...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.1.10/maps-ios-28.1.10.zip",
            checksum: "071c802eda3b93300a4d1887b0331ecb0982c2b9dd4ea228494add7221d1719e"
        )
    ]
)
