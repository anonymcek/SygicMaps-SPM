...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.9.7/maps-ios-25.9.7.zip",
            checksum: "0911bab492781810726ffd380248da2e746837f3ba6f5503bce9ee46bb279699"
        )
    ]
)
