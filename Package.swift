...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/25.6.2/maps-ios-25.6.2.zip",
            checksum: "7079a2a856555b07e7bd552335b332dd23ebe556ab55ede29af70efad2169b5f")
    ]
)
