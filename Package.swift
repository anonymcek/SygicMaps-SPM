...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/27.1.0/maps-ios-27.1.0.zip",
            checksum: "35abd388d01fe53fb5545de66a3c8aace1469dfdbf427306019ad9e9a40e6c0d"
        )
    ]
)
