...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.3.2/maps-ios-28.3.2.zip",
            checksum: "fd2e864a7ee651716ce3118e76d680f13afcc763f1129d1213dca783b21497a5"
        )
    ]
)
