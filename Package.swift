...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/27.1.1/maps-ios-27.1.1.zip",
            checksum: "a3f29fbae9838860eb3c0cc2da88e2b479547a1ea20109f8baf9d74712054799"
        )
    ]
)
