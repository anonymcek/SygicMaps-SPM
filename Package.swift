...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/29.0.0/maps-ios-29.0.0.zip",
            checksum: "6d5708f900f83b9e911098febf09f38a04b846494f17fe7612cd2d6016709ff0"
        )
    ]
)
