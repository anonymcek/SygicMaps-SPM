...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/28.3.0/maps-ios-28.3.0.zip",
            checksum: "dd7469b1957a93e19664e9b25df597158fa726d25443cc0c9141d4c9a5026828"
        )
    ]
)
