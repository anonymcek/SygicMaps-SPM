...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SygicMaps",
            url: "https://public.repo.sygic.com/repository/maven-sygic-releases/com/sygic/sdk/maps-ios/27.0.2/maps-ios-27.0.2.zip",
            checksum: "0d9f8d69f25509659234b11f25702076077a7f9518046daf7b5a89efdabdae85"
        )
    ]
)
